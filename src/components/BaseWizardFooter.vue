<template>
  <div class="flex flex-row-reverse justify-between bg-gray-100 mt-5 p-5 rounded-b-lg">
    <slot name="footer">
      ...
      <button type="button" class="btn btn-tertiary flex items-center" @click="$emit('prev')">
