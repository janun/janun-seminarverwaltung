...
# inspired by https://github.com/ctxis/django-admin-multiple-choice-list-filter
class MultipleListFilter(admin.SimpleListFilter):
    template = "admin/multiple_choice_list_filter.html"
