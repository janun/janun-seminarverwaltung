...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = models.User
        fields = (
            'pk', 'username', 'name', 'janun_groups', 'janun_groups_pks', 'group_hats', 'group_hats_pks', 'role',
...
class SeminarSerializer(serializers.ModelSerializer):
    ...
    owner = ShortUserSerializer(read_only=True)
    owner_pk = serializers.PrimaryKeyRelatedField(queryset=models.User.objects.all(), source='owner', required=False)
    group = ShortJANUNGroupSerializer(read_only=True)
    group_pk = serializers.PrimaryKeyRelatedField(queryset=models.JANUNGroup.objects.all(), source='group')
    ...
    class Meta:
        ...
        fields = (
            'pk', 'title', 'status', 'owner', 'owner_pk', 'group', 'group_pk',
